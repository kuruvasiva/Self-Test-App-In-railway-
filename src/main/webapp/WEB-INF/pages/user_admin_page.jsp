		...
		<nav class="navbar navbar-expand-lg">
			...
			<div
				...
				<div
					...
					<a href="multiInsert" class="btn btn-outline-success"> ➕ Insert
						Multiple Questions </a> <a class="btn btn-outline-primary"
						href="user_questions">Questions Data</a> <a
						class="btn btn-outline-info" href="resultsByUser">Result Data</a>
					<a class="btn btn-outline-warning" href="contact">Contact</a>
				</div>
		...
		<div class="">
			...
			<c:choose>
				<c:when test="${not empty quesDataList}">
					<h2 class="text-center text-primary mb-2">All Questions by
						User</h2>
							...
							<tbody>
								<c:forEach var="q" items="${quesDataList}">
									<tr class="table-primary">
										...
										<td>${q.answer}</td>
										<td><a href="updateQuestionByUser?qId=${q.questionId}"
											class="btn btn-outline-success btn-sm"> Edit</a></td>
										<td><a href="deleteQuestionByUser?qId=${q.questionId}"
				...
				<c:when test="${not empty resutlByUser}">
					<h2 class="text-center text-primary mb-2">All Results by User</h2>
					<div class="table-responsive table-secondary">
						<table
							class="table table-bordered table-striped table-hover align-middle text-center">
				...
				<c:otherwise>
					<h4 class="text-danger text-center">❌ No Questions Found or No
						User Results found</h4>
					<h3 class="text-success text-center">If you want question data
						or results data click above buttons</h3>
